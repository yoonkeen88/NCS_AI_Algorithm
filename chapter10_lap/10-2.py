...
# 오토인코더의 인코더 부분 설계
# 지금까지는 Sequential로 모델을 설계했지만, 이번에는 Functional API로 설계
encoder_input=Input(shape=(28,28,1))
x=Conv2D(32,(3,3),activation='relu',padding='same',strides=(1,1))(encoder_input) # C
x=Conv2D(64,(3,3),activation='relu',padding='same',strides=(2,2))(x) # C
x=Conv2D(64,(3,3),activation='relu',padding='same',strides=(2,2))(x) # C
x=Conv2D(64,(3,3),activation='relu',padding='same',strides=(1,1))(x) # C
x=Flatten()(x) # FC
...
decoded_img=model.predict(x_test) # 복원된 이미지
